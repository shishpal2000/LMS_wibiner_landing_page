...
const SyllabusCurriculum = () => {
  ...
  return (
    <div className="w-full p-[5%] bg-gradient-to-tr from-purple-100 via-orange-100 to-purple-100 flex flex-col items-center gap-5 mt-5 pt-8">
      <p className="text-3xl lg:text-4xl xl:text-5xl font-semibold">Curriculum</p>
